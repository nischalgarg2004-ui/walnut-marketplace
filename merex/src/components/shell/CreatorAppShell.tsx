  ...
  return (
    <div className="flex min-h-[100dvh] bg-background">
      <aside
        id="creator-sidebar"
        className={cn(
          "fixed inset-y-0 left-0 z-modal flex w-60 flex-col border-r border-border bg-sidebar text-sidebar-foreground transition-all lg:static lg:z-0 lg:translate-x-0",
          "lg:w-60",
