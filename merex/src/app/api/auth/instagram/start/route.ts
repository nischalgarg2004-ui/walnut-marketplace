...
import { buildInstagramAuthorizeUrlWithRedirectUri, createInstagramState, resolveInstagramRedirectUri } from "@/lib/integrations/instagram";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const state = createInstagramState({ mode, email, role, nonce });
