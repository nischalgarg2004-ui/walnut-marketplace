...
const DEMO_PASSWORD = "MerexDemo2026!";
...
const creators: CreatorSeed[] = [
  ...
  {
    email: "divya.krishnan@merex.demo",
...
const businesses: BusinessSeed[] = [
  {
    email: "brand.glowskin@merex.demo",
    legalName: "GlowSkin Labs Pvt Ltd",
    brandName: "GlowSkin",
    category: "Beauty & Personal Care",
    website: "https://glowskin.merex.demo",
    billingEmail: "billing@glowskin.merex.demo",
    gstinPlaceholder: "27AAAAA0000A1Z5"
  },
  {
    email: "brand.fitfuel@merex.demo",
    legalName: "FitFuel Nutrition India LLP",
    brandName: "FitFuel",
    category: "Health & Nutrition",
    website: "https://fitfuel.merex.demo",
    billingEmail: "ap@fitfuel.merex.demo",
    gstinPlaceholder: "29BBBBB0000B1Z4"
  },
  {
    email: "brand.technova@merex.demo",
    legalName: "TechNova India Private Limited",
    brandName: "TechNova",
    category: "Consumer Electronics",
    website: "https://technova.merex.demo",
    billingEmail: "finance@technova.merex.demo",
    gstinPlaceholder: "07CCCCC0000C1Z3"
  },
  {
    email: "brand.spiceroute@merex.demo",
    legalName: "SpiceRoute Foods Pvt Ltd",
    brandName: "SpiceRoute",
    category: "Food & Beverage",
    website: "https://spiceroute.merex.demo",
    billingEmail: "accounts@spiceroute.merex.demo",
    gstinPlaceholder: "24DDDDD0000D1Z2"
  },
  {
    email: "brand.wanderfest@merex.demo",
    legalName: "WanderFest Travel Co.",
    brandName: "WanderFest",
    category: "Travel & Hospitality",
    website: "https://wanderfest.merex.demo",
    billingEmail: "ops@wanderfest.merex.demo",
...
async function main() {
  ...
  const seedAdminEmail = process.env.ADMIN_SEED_EMAIL?.trim();
  const seedAdminPassword = process.env.ADMIN_SEED_PASSWORD;
  let adminEmail: string;

  if (seedAdminEmail && seedAdminPassword && seedAdminPassword.length >= 6) {
    const seedHash = hashSync(seedAdminPassword, 10);
    await prisma.user.upsert({
      where: { email: seedAdminEmail },
      update: { passwordHash: seedHash, role: UserRole.ADMIN, status: "ACTIVE" },
      create: {
  ...
  const dummyVars = {
    ...
    admin: {
      email: adminEmail,
      password:
        seedAdminEmail && seedAdminPassword && seedAdminPassword.length >= 6
