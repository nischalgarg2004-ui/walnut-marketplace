...
(async () => {
  ...
  const cmd = `start "" "${chromePath}" --remote-debugging-port=9222`;
  ...
  console.log('Waiting 5 seconds for Chrome to launch...');
  ...
  try {
    ...
    console.error('Failed to connect to Chrome. Make sure no other Chrome instances were running when you started the script.');
  ...
  console.log('1. If you are not logged in, please log in to your Figma account.');
  console.log('2. Make sure the Figma design file or prototype is fully loaded.');
  console.log('3. Press the "Play" presentation button (or open the prototype view) to start the background video.');
  ...
  if (!videoUrlFound) {
    ...
    console.log('Navigated to prototype. Waiting another 15 seconds...');
